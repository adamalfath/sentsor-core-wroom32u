/* =====================================================================
  ...
  Project      : Core Board WROOM-32U - Self test
...
void setup() {
  ...
  delay(500);
  DEBUG_OUT(F("\n\nSENTSOR Core Board WROOM-32U Self-Test\n"));
  delay(500);
  ...
  //SD test: SD init with slave select (SS) at pin 5, write/read/delete file
  ...
  for (uint8_t i = 0; i < networkFound; i++) {
    ...
    DEBUG_OUT(String(WiFi.encryptionType(i) == WIFI_AUTH_OPEN ? "Open" : "Encrypted") + "\n");
  }
